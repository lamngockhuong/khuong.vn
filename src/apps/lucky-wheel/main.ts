...
import './styles.css'
import { LuckyWheel, Segment } from './wheel'
...
function init(): void {
  ...
  const segmentsInput = document.getElementById('segments-input') as HTMLTextAreaElement
  const updateBtn = document.getElementById('update-btn') as HTMLButtonElement

  if (!canvas || !spinBtn || !resultDiv || !resultText || !segmentsInput || !updateBtn) {
